  ...
  return (
    <div className="h-screen bg-[#000a0f] flex justify-evenly items-center">
      <div className="text-white flex items-center gap-6">
        ...
        <p className=" text-5xl font-[Roboto] font-bold">Food explorer</p>
      </div>
      <div className="text-white border bg-[#001119] w-[445px] p-3 py-9 rounded-2xl border-[#001119] flex justify-center items-center flex-col ">
        ...
        <div class="relative w-[345px]">
          <p id="input" className="text text-[#C4C4CC] font-[Roboto] py-3">Email : </p>
        ...
        <div class="relative w-[345px]">
          <p id="inputs" className="text text-[#C4C4CC] font-[Roboto] py-3">Senha : </p>
          <div class="absolute top-0 flex w-full justify-center">
            <div class="h-[1px] animate-border-width rounded-full bg-gradient-to-r from-[rgba(17,17,17,0)] via-white to-[rgba(17,17,17,0)] transition-all duration-1000" />
          </div>
          <input type="password" 
        ...
        <button  onClick={clicks} className="group/button relative w-[340px] inline-flex items-center justify-center overflow-hidden rounded-md  bg-red-500 px-4 p-3.5 text-xs font-normal text-white transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-red-500/30">
        ...
        <p className='text-[18px]'> Criar <Link to={'/signup'} className='text-red-500'>uma conta</Link></p>
      </div>
    </div>
  );
}
